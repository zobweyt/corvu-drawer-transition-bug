    ...
    <Drawer breakPoints={[0.75]} velocityFunction={() => 1}>
      {(props) => (
        <>
          ...
          <Drawer.Portal>
            <Drawer.Overlay
              class="fixed inset-0 z-50 corvu-transitioning:transition-colors corvu-transitioning:duration-1000 corvu-transitioning:ease-[cubic-bezier(0.32,0.72,0,1)]"
              style={{
            ...
            <Drawer.Content class="fixed inset-x-0 bottom-0 z-50 flex h-full max-h-[500px] flex-col rounded-t-lg border-t-4 border-corvu-400 bg-corvu-100 pt-3 after:absolute after:inset-x-0 after:top-[calc(100%-1px)] after:h-1/2 after:bg-inherit corvu-transitioning:transition-transform corvu-transitioning:duration-1000 corvu-transitioning:ease-[cubic-bezier(0.32,0.72,0,1)] md:select-none">
              ...
              <Drawer.Close class="duration-75 transition active:transition-none active:bg-corvu-400 hover:bg-corvu-300">
                Close (75ms)
              </Drawer.Close>
            </Drawer.Content>
          </Drawer.Portal>
